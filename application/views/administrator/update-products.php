            ...
            <div class="page-body">
                <div class="row">
                    <div class="col-sm-12">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <select name="cat_id" class="form-control form-control-primary" onchange="getsubcategoriy(this.value)">
						...
						<?php $catsy_id = $productsDetails['cat_id'];
							$updatesub = $this->Administrator_Model->getsubcategoriesbycid($catsy_id);
							
							
		$subcategory = $updatesub[0]['sub_category'];
		$sub_explode = explode(',',$subcategory);
						?>
                                                        <div class="row">
														<div class="col-sm-6" id="sbscategory">
                                                                <select name="subcat_id" class="form-control form-control-primary">
                                                                    <option value="">Select a Sub Category</option>
                                                                    
                                                                    <?php foreach($sub_explode as $sbpost) : ?>
                                                                         <option value="<?php echo $sbpost; ?>" <?php if($productsDetails['sub_cat'] == $sbpost){ echo "selected" ; } ?>><?php echo $sbpost; ?></option>
													    ...
													    <div class="col-sm-6">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="icofont icofont-all-caps"></i></span>
                                                                    <input class="form-control" name="button_name" placeholder="Button Name" type="text" value="<?php echo $productsDetails['button_name']; ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="icofont icofont-underline"></i></span>
                                                                    <input class="form-control" name="button_link" placeholder="Button Link" type="text" value="<?php echo $productsDetails['button_link']; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-2">
                                                                <div class="input-group">
                                                                   <img src="<?php echo site_url();?>assets/images/products/<?php echo $productsDetails['image']; ?>" width="50px" height="50px">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
...
<script>
   function getsubcategoriy(catid){
	    var base_url = '<?= base_url() ?>';
		//alert(base_url);
	    $.ajax({
        url: base_url+'administrator/getsubcategoriesbyid',
        data: {'catid': catid}, 
        type: "post",
        success: function(data){
          // console.log(data);
		      $('#sbscategory').html(data);
        }
      }); 
   }
   </script>   
