                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                             ...
                             <div class="col-sm-8">
                               <?php echo form_open_multipart('administrator/update_product_category_data'); ?>
                               <input type="hidden" name="id" value="<?php echo $productcategory['id']; ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="sub_name" class="form-control" placeholder="Sub Category Name" value="<?php echo $productcategory['sub_category']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="checkbox" value="1" name="status" class="js-single"
                                             <?php if($productcategory['status'] == '1'){ echo "checked"; } ?> />
                                        </div>
                                    </div>
