            ...
            <div class="page-header">
                ...
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Create Product Category</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                             ...
                             <div class="col-sm-8">
                               <?php echo form_open_multipart('administrator/create_product_category'); ?>
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="sub_name" class="form-control" placeholder="Sub Category Name">
                                        </div>
                                    </div>
