        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body" style = " margin-left: 50%;">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="row m-b-20">
                                    <div class="col-md-6">
                                        <h3 class="text-left txt-primary">Sign In</h3> </div>
										<img style="width: 128px;height: 75px;" src="https://eyelooks.in/wp-content/uploads/2018/10/imageedit_1_6838559865.png" class="img-fluid header-logo" alt="EyeLooks">
