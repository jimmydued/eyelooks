                                                ...
                                                <div class="tab-pane active" id="">
														...
														<div class="col-sm-6" id="sbscategory">
                                                                <select name="subcat_id" class="form-control form-control-primary">
                                                                    ...
                                                                    <?php //foreach($product_categories as $post) : ?>
                                                                        <option value="ContactLenses">Contact Lenses</option><option value="PowerEyeglasses">Power Eyeglasses</option><option value="PowerSunglasses">Power Sunglasses</option><option value="Sunglasses">Sunglasses</option>
                                                                     <?php //endforeach; ?>
                                                       ...
                                                       <div class="row">
													    <div class="col-sm-6">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="icofont icofont-all-caps"></i></span>
                                                                    <input class="form-control" name="button_name" placeholder="Button Name" type="text">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i class="icofont icofont-underline"></i></span>
                                                                    <input class="form-control" name="button_link" placeholder="Button Link" type="text">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
